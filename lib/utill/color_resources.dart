...
class ColorResources {
  ...
  static const Color greyShado600 = Color(0xff757575);
  ...
  static const Color primaryColor = Color(0xfff85100);
  static const Color primaryColorShodo = Color(0xffffe1d3);


  // ------------->>>> App Color Source <<<<-----------------
  static const Color splashBorder = Color(0xffffcd29);
  static const Color flateColor = Color(0xfffc9803);
  static const Color backGroundColor = Color(0xfff6f3f3);
  ...
  // ------------->>>> App Color Source <<<<-----------------
  // static const Color primaryColor = Color(0xff024a56); // --->> Favourite Screen Button Color
